  ...
  <div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        {{Form::open(['route' => ['management.update', $management->id], 'files' => true])}}
        ...
        {{-- <form method="post" action="{{url('user/'.$user->id)}}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"> --}}
            <input type="hidden" name="_method" value="PUT">
             ...
             <div class="item form-group row">
              ...
              <label class="col-form-label " for="old-name">First Name<span class="required">*</span>
                  ...
                  {{Form::text('firstName',$management->firstName,['required','class' => 'form-control']) }}
              </div>

              <div class="col-md-6 col-xs-12 ">
              <label class="col-form-label" for="old-name">Last Name<span class="required">*</span>
              </label>
                  {{Form::text('lastName',$management->lastName,['required','class' => 'form-control']) }}
              </div>
            </div>
            ...
            <div class="item form-group row">
              ...
              <label class="col-form-label" for="old-name">Email<span class="required">*</span>
                  ...
                  {{Form::email('email',$management->email,['required','class' => 'form-control']) }}
              </div>

              <div class="col-md-6 col-xs-12 ">
              <label class="col-form-label" for="old-name">Mobile<span class="required">*</span>
              </label>
                  {{Form::text('mobile',$management->mobile,['required','class' => 'form-control']) }}
              </div>
            </div>
            ...
            <div class="item form-group row">
              ...
              <label class="col-form-label" for="old-name">Address<span class="required">*</span>
                  ...
                  {{Form::text('address',$management->address,['required','class' => 'form-control']) }}
              </div>
              
              <div class="col-md-6 col-xs-12 ">
              <label class="col-form-label" for="old-name">City<span class="required">*</span>
              </label>
                  {{Form::text('city',$management->city,['required','class' => 'form-control']) }}
              </div>
            </div>
            ...
            <div class="item form-group row">
                ...
                <div class="col-md-6 col-xs-12 ">
                  <label class="col-form-label" for="old-name">Permission<span class="required">*</span>
                    ...
                    {{Form::select('permission',$permission,$management->permission,['required','class' => 'form-control' , 'placeholder' => '------'])}}
                  </div>
                ...
                {{Form::checkbox('branches[]', $branch->id , (in_array($branch->id,explode(',',$management->branches)))?true:false )}}
                ...
                @endforeach
                    ...
                    {{-- <div class="col-md-6 col-xs-12 ">
                      ...
                      {{Form::select('branch', $branches,$management->branch_id,['required','class' => 'form-control', 'placeholder'=>'Choose Branch']) }}
                      </div> --}}
            </div>
            ...
            <div class="col-md-12 col-xs-12 ">
              ...
              <td>
                @if($management->profileImage != null)
                <img src="{{ URL('/') }}/uploads/{{$management->profileImage}}" style="max-height:100px"/>
                @else
                      No image
              </td>
              @endif
            ...
            <div class="item form-group row">
              ...
              <label class="col-form-label" for="old-name">Notes<span class="required">*</span>
                  ...
                  {{Form::textarea('notes',$management->notes,['required','class' => 'form-control']) }}
              </div>
            </div>
