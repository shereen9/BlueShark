  ...
  <div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        {{Form::open(['route' => ['trainer.update', $trainer->id], 'files' => true])}}
        ...
        {{-- <form method="post" action="{{url('user/'.$user->id)}}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"> --}}
            <input type="hidden" name="_method" value="PUT">
             ...
             <div class="item form-group row">
              ...
              <label class="col-form-label " for="old-name">First Name<span class="required">*</span>
                  ...
                  {{Form::text('firstName',$trainer->firstName,['required','class' => 'form-control']) }}
              </div>

              <div class="col-md-6 col-xs-12 ">
              <label class="col-form-label" for="old-name">Last Name<span class="required">*</span>
              </label>
                  {{Form::text('lastName',$trainer->lastName,['required','class' => 'form-control']) }}
              </div>
            </div>
            ...
            <div class="item form-group row">
              ...
              <label class="col-form-label" for="old-name">Email<span class="required">*</span>
                  ...
                  {{Form::email('email',$trainer->email,['required','class' => 'form-control']) }}
              </div>

              <div class="col-md-6 col-xs-12 ">
              <label class="col-form-label" for="old-name">Mobile<span class="required">*</span>
              </label>
                  {{Form::text('mobile',$trainer->mobile,['required','class' => 'form-control']) }}
              </div>
            </div>
            ...
            <div class="item form-group row">
              ...
              <label class="col-form-label" for="old-name">Address<span class="required">*</span>
                  ...
                  {{Form::text('address',$trainer->address,['required','class' => 'form-control']) }}
              </div>
              
              <div class="col-md-6 col-xs-12 ">
              <label class="col-form-label" for="old-name">City<span class="required">*</span>
              </label>
                  {{Form::text('city',$trainer->city,['required','class' => 'form-control']) }}
              </div>
            </div>
            ...
            <div class="item form-group row">
              ...
              <div class="col-md-6 col-xs-12 ">
                <label class="col-form-label" for="old-name">Salary Per Hour<span class="required">*</span>
                     ...
                     {{Form::number('salary_per_hour',$trainer->salary_per_hour,['required','class' => 'form-control']) }} 
                </div>
                
                <div class="col-md-6 col-xs-12 ">
                  <label class="col-form-label" for="old-name">Salary Per Month<span class="required">*</span>
                  </label>
                     {{Form::number('salary_per_month',$trainer->salary_per_month,['required','class' => 'form-control']) }}
                  </div>
            </div>
            ...
            {{Form::checkbox('branches[]', $branch->id , (in_array($branch->id,explode(',',$trainer->branches)))?true:false )}}
            ...
            @endforeach
                ...
                {{-- <div class="col-md-6 col-xs-12 ">
                  ...
                  {{Form::select('branch', $branches,$trainer->branch_id,['required','class' => 'form-control', 'placeholder'=>'Choose Branch']) }}
                  </div> --}}
              ...
              <br>
                ...
                {{Form::checkbox('sports[]', $sport->id,(in_array($sport->id,explode(',',$trainer->sports)))?"selected":"" )}}
            ...
            {{-- <div class="item form-group row"> --}}
              ...
              <div class="col-md-12 col-xs-12 ">
                ...
                <td>
                  ...
                  <img src="{{ URL('/') }}/uploads/{{$trainer->profileImage}}" style="max-height:100px"/>
                  @else
                  No image
            </td>
            @endif
            ...
            <div class="item form-group row">
              ...
              <label class="col-form-label" for="old-name">Notes<span class="required">*</span>
                  ...
                  {{Form::textarea('notes',$trainer->notes,['required','class' => 'form-control']) }}
              </div>
            </div>
