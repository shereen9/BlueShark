...
<div class="x_panel">
    <div class="x_title">
      ...
      <ul class="nav navbar-right panel_toolbox">
        <li>
        <a href="{{route('group.create')}}"><i class="fa fa-plus"></i> New</a>
        </li>
    ...
    <div class="x_content">
      ...
      <table class="table">
        ...
        <tbody>
          ...
          {{-- <td>{{$group->fees}}</td> --}}
          {{-- <td>{{$group->count}}</td> --}}
          <td>{{$group->subscriptionDate}}</td>
          <td>{{$group->responsible_name}}</td>
          <td>
            <?php $branches = explode(',',$group->branches); ?>
        ...
        @endforeach
          ...
          <td class=" last">
            <a class="edit" href="{{route('group.edit',['group'=>$group->id])}}"><span class="glyphicon glyphicon-edit"></a>
