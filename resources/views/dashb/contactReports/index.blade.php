...
<div class="x_panel">
    <div class="x_title">
      <h2>Contact Attendance Reports</h2>
    ...
    <div class="x_content">
      ...
      <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
            {{Form::select('sport',$sports,'',['class' => 'form-control sport','placeholder' => '------']) }}
        </div>
      </div>

<button class="btn btn-success" onclick="getContactData()">Get data</button>
