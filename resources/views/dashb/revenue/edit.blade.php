  ...
  <div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        {{Form::open(['route' => ['revenue.update', $revenue->id], 'files'=>true])}}
        ...
        {{-- <form method="post" action="{{url('user/'.$user->id)}}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"> --}}
            <input type="hidden" name="_method" value="PUT">
             ...
             <div class="item form-group ">
              ...
              <div class="col-md-6 col-xs-12 ">
                  ...
                  {{Form::text('statement',$revenue->statement,['required','class' => 'form-control']) }}
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-xs-12 ">
                    {{Form::text('amount',$revenue->amount,['required','class' => 'form-control']) }}
                </div>
              </div>
              ...
              <div class="item form-group ">
                ...
                <div class="col-md-6 col-xs-12 ">
                      ...
                      {{Form::text('date',$revenue->amount,['required','class' => 'form-control datepicker','autocomplete' => 'off']) }}
                </div>
              </div>
              ...
              <div class="item form-group row">
                ...
                <div class="col-md-6 col-xs-12 ">
                    {{Form::textarea('notes',$revenue->notes,['required','class' => 'form-control', 'rows'=>'3']) }}
                </div>
              </div>
