  ...
  <div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        {{Form::open(['route' => ['branch.update', $branch->id]])}}
        ...
        {{-- <form method="post" action="{{url('user/'.$user->id)}}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"> --}}
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
                {{Form::text('name',$branch->name,['required','class'=>'form-control' ])}}
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
                {{Form::text('address',$branch->address,['required','class' => 'form-control']) }}
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
                {{Form::text('telephone', $branch->telephone,['required','class' => 'form-control']) }}
              {{-- <input name="name" type="text" id="first-name" required="required" class="form-control"  > --}}
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
                {{Form::text('responsible', $branch->responsible,['required','class' => 'form-control']) }}
              {{-- <input name="name" type="text" id="first-name" required="required" class="form-control"  > --}}
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
              ...
              {{Form::checkbox('sports[]', $sport->id, (in_array($sport->id,explode(',',$branch->sports)))?"selected":"" )}}
