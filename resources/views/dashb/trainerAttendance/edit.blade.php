  ...
  <div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        {{Form::open(['route' => ['tAttendance.update', $tAttend->id]])}}
        ...
        {{-- <form method="post" action="{{url('user/'.$user->id)}}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"> --}}
            <input type="hidden" name="_method" value="PUT">
             ...
             <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 ">
                  {{Form::text('date',$tAttend->date,['class' => 'form-control datepicker','autocomplete'=> 'off']) }}
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 ">
                {{Form::number('over',$tAttend->over,['class' => 'form-control']) }}
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 ">
                {{Form::number('penality',$tAttend->penality,['class' => 'form-control']) }}
              </div>
            </div>
            ...
            <div class="item form-group">
              <label class="col-form-label col-md-3 col-sm-3 label-align" for="old-name">Attend?<span class="required">*</span>
                  ...
                  <div class="custom-control custom-radio" style="margin-top:5px;">
                    {{Form::radio('attend','1',$tAttend->status==1?true:false) }}
                    <label class="radio-inline" for="defaultGroupExample1">Yes</label>
                  </div>

                  <!-- Group of default radios - option 2 -->
                  <div class="custom-control custom-radio" style="margin-top:5px;">
                    {{Form::radio('attend', '0',$tAttend->status==0?true:false) }}
