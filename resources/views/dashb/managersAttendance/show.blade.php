...
<div class="x_panel">
    <div class="x_title">
      <h2>{{$manager->firstName}} {{$manager->lastName}}'s Attendances</h2>
    ...
    <div class="x_content">
      ...
      <table class="table">
        ...
        <td class=" last">
            <a class="edit" href="{{route('mAttendance.edit',['mAttendance'=>$mAttend->id])}}"><span class="glyphicon glyphicon-edit"></a>
        </td>
        <td class=" last">
          <form method="POST" action="{{route('mAttendance.destroy',['mAttendance'=>$mAttend->id])}}">
                  @method('delete')
                  @csrf
