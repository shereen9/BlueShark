...
<div class="x_panel">
    <div class="x_title">
      <h2>Managers Attendance Reports</h2>
...
<button class="btn btn-success" onclick="getManagementData()">Get data</button>
